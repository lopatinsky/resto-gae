...
def prepare_order(order, customer, payment_type):
    ...
    if not order.is_delivery:
        ...
        if order.venue_id == CompanyNew.ORANGE_EXPRESS:
            ...
            dt_mapping = {
                u"Азов": "19f93854-08b3-9a01-014f-ff67378c3c95",
                u"Ростов-на-Дону": "1ed5add4-a920-555c-0151-ae18ae4caa35",
            }
            obj['deliveryTerminalId'] = dt_mapping.get(order.address.get('city'))
        ...
        elif order.venue_id in (CompanyNew.BURGER_CLUB, CompanyNew.CHAIHANA_LOUNGE, CompanyNew.DEMO_SOFT_BUSINESS):
