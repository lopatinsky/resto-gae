    ...
    CompanyNew.DIMASH: [
        {
            ...
            "description": u"В случае опоздания курьера на 1 минуту и более, мы ГАРАНТИРУЕМ "
                           u"к следующему Вашему заказу ПОДАРОК на выбор: "
                           u"Ассорти-Сет «Свежесть» или Пицца «ЧЕТЫРЕ СЫРА 31см» (Итальяно)."
                           u"Подробности акции Вы можете уточнить у оператора, "
                           u"который будет Вам звонить для подтверждения заказа.",
            "start": None,
            "end": None,
            "image_url": None,
            "id": "0",
